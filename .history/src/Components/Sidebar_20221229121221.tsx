...
function Sidebar() {
    ...
    const usermail = JSON.parse.toString(localStorage.getItem('useremail'));
    const handleLogout = () => {
    ...
    return (
        ...
        <>
            ...
            <nav className="navbar bg-dark" id='id'>
                <NavDropdown id="nav-dropdown" className="border rounded p-2 mb-1 bg-white text-dark" title={usermail}>
