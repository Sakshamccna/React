...
function Sidebar() {
    ...
    return (
        ...
        <>
            ...
            <nav id="sidebarMenu" className=" d-lg-block navbar-expand-lg navbar-light sidebar bg-dark">
            ...
            <nav className="navbar bg-dark" id='id'>
                <NavDropdown id="nav-dropdown" className="border rounded p-2 mb-1 mx-2 bg-white text-dark" title={usermail}>
